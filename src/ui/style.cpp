...
static void _init_fonts(ImGuiIO& io)
{
    ...
    _FONT_SIZES[SMALL | BOLDITALIC] = 10.f;
    _FONT_SIZES[NORMAL | REGULAR]   = 15.f;
    _FONT_SIZES[NORMAL | BOLD]      = 15.f;
    _FONT_SIZES[NORMAL | ITALIC]    = 15.f;
    _FONT_SIZES[SMALL | BOLDITALIC] = 16.f;
    _FONT_SIZES[LARGE | REGULAR]    = 24.f;
    _FONT_SIZES[LARGE | BOLD]       = 24.f;
    _FONT_SIZES[LARGE | ITALIC]     = 24.f;
    _FONT_SIZES[SMALL | BOLDITALIC] = 24.f;
    _FONT_SIZES[SMALL | ICON]       = 12.0f;
    _FONT_SIZES[NORMAL | ICON]      = 15.0f;
    _FONT_SIZES[LARGE | ICON]       = 24.0f;
